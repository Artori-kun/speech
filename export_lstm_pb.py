...
def make_cell(hidden_layer):
    return tf.compat.v1.nn.rnn_cell.LSTMCell(num_hidden, state_is_tuple=True)
...
with tf.compat.v1.Session() as sess:
    ...
    with tf.io.gfile.GFile("/home/minhhiu/MyProjects/speech/model/lstm_model.pb", "wb") as f:
